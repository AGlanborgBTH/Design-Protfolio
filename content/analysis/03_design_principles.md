...
<!--Skillnaden mellan de tre utvalda sidorna och min sida är att de är artister som vill sälja produkter till konsumenter. Så de har gjort sina sidor för att pressentera produkter och försöka skapa flask viktighet i det de försöker lyfta fram. Min sida är gjord för att pressentera artiklar och rapporter, därför är den gjord monotonskt. Det gör att läsaren inte blir distraherad under tiden som de läser texte och den pressentera innehållet i ett format som inte lyfter fram viss innehåll över annat. Man kan använda färg-gladare färger och fortfarande pressentera innehåll jämständigt, men det är inte vad mitt mål var. Minimalism var målet med min sida. Vilket Aries sida också använder, men på ett annat sätt. Aries sida pressenterar 4 länkar på en sida, för att de fyra länkarna räcker för att visa upp allt innehåll. Om jag inte hade några karv på min sida så skulle jag göra en sida som efterliknar Aries sida, men eftersom jag har några måsten i min sida så är den gjord enbart för att uppfylla de kraven. Innehållet som efterfrågas är artiklar och rappporter som är placerats på specifika sidor, vilket minimerar min förmåga att ändra saker. Det är en till motivering till att jag valde att göra en monotonsk, minimalist sida.-->
...
Ed Sheeran. (2021). *Warner Music UK Limited*. Hämtad december 21, 2021 från [https://www.edsheeran.com/](https://www.edsheeran.com/)
